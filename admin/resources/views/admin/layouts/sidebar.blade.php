...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        {{-- <h3 style="color: white; margin-right: 10px">Driven</h3> --}}
        <a href="index.html" class="brand-logo">
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <br>
                <li class="menu-item menu-item-active" aria-haspopup="true">
                    <a href="{{url('imagecategory')}}" class="menu-link">
                        <span class="svg-icon menu-icon">
                ...
                <br>
                <li class="menu-item menu-item-active" aria-haspopup="true">
                    <a href="{{url('image')}}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                ...
                <br>
                <li class="menu-item menu-item-active" aria-haspopup="true">
                    <a href="{{url('frame')}}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                ...
                <br>
                  ...
                  <li class="menu-item menu-item-active" aria-haspopup="true">
                    <a href="{{url('testframe')}}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\File-cloud.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="topbar-item">
                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2">
                        <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">
                            <form id="logoutForm" action="{{ route('doLogout') }}" method="post">
                                @csrf
