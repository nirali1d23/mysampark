        ...
        <div class="card card-custom">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="<?php echo e(url('/createimages')); ?>" class="btn btn-primary font-weight-bolder">
...
<script>
        ...
        $('#kt_datatable').DataTable({
            ...
            columns: [
                { data: "id" },
                {
                    ...
                    {
                        return `<img src="/images/${data}" alt="Image" style="width: 50px; height: auto;" />`;
                    }
                },
                {
                    data: null,
    ...
    function deleteItem(deleteid) 
    {
        if (confirm("Are you sure you want to delete this?")) {
            $.ajax({
                url: "deleteimagecategory/" + deleteid,
                type: 'DELETE',
                data: { _token: "<?php echo e(csrf_token()); ?>" },
                success: function () {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\postermaker\postermaker\resources\views/admin/imagedisplay.blade.php ENDPATH**/ ?>