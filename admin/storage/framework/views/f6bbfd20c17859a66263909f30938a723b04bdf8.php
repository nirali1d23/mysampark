        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <form class="form" id="myform" enctype="multipart/form-data" action="<?php echo e(url('/updateimage/' . $image->id )); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    <label>Category name:</label>
                                    <input type="text" class="form-control" placeholder="Enter category name" name="name" value="<?php echo e($image->name); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="image-input image-input-outline" id="hero_image_input_container">
                                        <div id="hero_image_preview_container" class="d-flex flex-wrap">
                                            <img src="<?php echo e(url("images/" . $image->image)); ?>" id="hero_image_preview" alt="Hero Image" style="max-height: 300px;
                            ...
                            <div class="form-group row">
                                ...
                                <div class=" " id="gallary_images">
                                    ...
                                    <?php $__currentLoopData = $displayimage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="image-input image-input-outline" id="kt_image_<?php echo e($key+1); ?>">
                                        <div id="imagePreviewContainer<?php echo e($key+1); ?>" class="d-flex flex-wrap position-relative">
                                          
                                            <img src="<?php echo e(url('images/' . $image->image)); ?>" alt="Old Image" style="max-height: 300px; max-width: 120px;" class="img-fluid">
                                            <span class="remove-image-btn" onclick="removeImage(<?php echo e($key+1); ?>)">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\postermaker\postermaker\resources\views/admin/image_edit.blade.php ENDPATH**/ ?>