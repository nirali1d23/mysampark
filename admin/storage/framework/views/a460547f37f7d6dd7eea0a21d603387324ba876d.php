...
<script>
   ...
   // <button class="btn btn-primary" onclick="editItem(${data.id})">Edit</button>
    ...
    {
        window.location.href = "<?php echo e(url('editimage')); ?>/" + editid;
    }
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u273329571/domains/bestdevelopmentteam.com/public_html/postermaker/resources/views/admin/imagedisplay.blade.php ENDPATH**/ ?>