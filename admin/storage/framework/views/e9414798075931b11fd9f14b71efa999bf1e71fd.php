        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Pesonal Category List</h3>
                </div>
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="<?php echo e(route('store_personal_image', ['id' => request()->id])); ?>" class="btn btn-primary font-weight-bolder">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\postermaker\postermaker\resources\views/admin/personalcategory_list.blade.php ENDPATH**/ ?>