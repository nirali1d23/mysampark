...
function editImage(editid) {
        window.location.href = "<?php echo e(url('editframe')); ?>/"+ editid;
    }

    function appparameter(editid) {
        window.location.href = "<?php echo e(url('appparamter')); ?>/"+ editid;
    }


</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u273329571/domains/bestdevelopmentteam.com/public_html/postermaker/resources/views/admin/framedisplay.blade.php ENDPATH**/ ?>