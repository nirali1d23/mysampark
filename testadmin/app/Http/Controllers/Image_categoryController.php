...
public function display_frame_category(Request $request)
{
    $data = Framecategory::all();
...
public function create_framecategory(Request $request)
{
    $request->validate([
...
public function framecategory_delete(Request $request)
{
    $request->validate([
     ...
     $data = Framecategory::find($request->id);
...

     {
        ...
        $images = Frame::where('frame_category_id',$request->id)->get();
...
public function framecategory_update_api(Request $request)
{
    $request->validate([
  ...
  $product = Framecategory:: find($request->frame_category_id);
