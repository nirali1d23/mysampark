                            ...
                            <form class="form" novalidate="novalidate" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg"
                                        type="email"   value="{{old('email')}}"  placeholder="enter your email" name="email" autocomplete="off" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg"
                                        type="password" placeholder="enter your password" name="password"  value="{{old('password')}}"
                                        autocomplete="off" />
